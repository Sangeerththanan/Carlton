...
namespace Carlton.CustomerSelfService.Features.Flights.Repositories;
...
public class FlightRepository : IFlightRepository
{
    ...
    public async Task<Flight?> UpdateAsync(int id, Flight flight)
    {
        ...
        existingFlight.Stops = flight.Stops;
        existingFlight.HasCheckInBaggage = flight.HasCheckInBaggage;
        existingFlight.HasHandLuggage = flight.HasHandLuggage;
