...
public class ServicePackageCatalogItemConfiguration : IEntityTypeConfiguration<ServicePackageCatalogItem>
{
    public void Configure(EntityTypeBuilder<ServicePackageCatalogItem> entity)
    {
