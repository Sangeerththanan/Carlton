...
public class FlightHotelSearchConfiguration : IEntityTypeConfiguration<FlightHotelSearch>
{
    public void Configure(EntityTypeBuilder<FlightHotelSearch> entity)
    {
