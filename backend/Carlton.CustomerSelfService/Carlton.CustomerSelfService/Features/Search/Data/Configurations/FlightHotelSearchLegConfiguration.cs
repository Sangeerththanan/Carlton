...
public class FlightHotelSearchLegConfiguration : IEntityTypeConfiguration<FlightHotelSearchLeg>
{
    public void Configure(EntityTypeBuilder<FlightHotelSearchLeg> entity)
    {
